...
function PineBio() {
  return <div>Personalized treatment for heart conditions</div>;
}
function P4() {
  return (
    <div>
...
function Turtle() {
  ...
  return <button>{TurtleButton}</button>;
}
...
function Valid() {
  const newval = true;
  return <div>{newval ? "this is valid" : "this is not valid"}</div>;
}

function Isgreat() {
  const itIsGreat = false;
  return <div>{itIsGreat ? "This great" : "this is not great"}</div>;
}
...
function Validity() {
  ...
  return (
    <div>
      {Check
        ? "this a validity indicatior"
        : "This is not a validity indicator"}
...
//   );
// }
// //rewriting it as an anonymous function and stored in a (constant) variable
...
// // Turning an anonymous function to an arrow function
// const LikeButton = () => {
//   return (
//     <i className="fa fa-heart like-button"/>
//   );
// }
// // removing the return  and the braces

// const LikeButton = () => (<i className="fa fa-heart like-button" />);

// // Writing a simple one line function
// // const Hi = () => <span>Hi Professor Chukwudumebi</span>
...
// const LikeButton = function () {
//   return (
//     <i className="fa f-heart like-button" />
//   );
// }
// const LikeButton = () => {
//   return (
...
//   );
// }
// const LikeButtton = () => (<i className="fa fa-heart like-button" />);
// const LikeButton = () => <span>Hi Professor Chukudumebi BlondeW</span>;
ReactDOM.render(
  <div>
    <HelloWorld /> <Hello />
    <Ello /> <Excell /> <ToDo />
